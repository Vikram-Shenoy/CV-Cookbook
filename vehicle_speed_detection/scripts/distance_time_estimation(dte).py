...
data_output = "vehicle_speed_detection/data"
cap = cv2.VideoCapture("vehicle_speed_detection/videos/input/highway_clipped.mp4")
fps = int(cap.get(cv2.CAP_PROP_FPS))
w = int(cap.get(cv2.CAP_PROP_FRAME_WIDTH))
h = int(cap.get(cv2.CAP_PROP_FRAME_HEIGHT))
out = cv2.VideoWriter("vehicle_speed_detection/videos/output/dte_output.mp4", cv2.VideoWriter_fourcc(*"mp4v"), fps, (w, h))
