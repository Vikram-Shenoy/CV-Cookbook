...
class AppConfig:
    ...
    video_path: str = "2. vehicle_speed_detection/videos/input/highway_clipped.mp4"
    output_video_path: str = '2. vehicle_speed_detection/videos/output/sparse_flow_output.mp4'
    output_csv_prefix: str = '2. vehicle_speed_detection/data/sparse_flow_data_zone'
