...
import os
# Suppress warnings from ultralytics
import warnings
warnings.filterwarnings("ignore", category=RuntimeWarning, module='ultralytics')
...
data_output = "2. vehicle_speed_detection/data"
cap = cv2.VideoCapture("2. vehicle_speed_detection/videos/input/highway_clipped.mp4")
fps = int(cap.get(cv2.CAP_PROP_FPS))
w = int(cap.get(cv2.CAP_PROP_FRAME_WIDTH))
h = int(cap.get(cv2.CAP_PROP_FRAME_HEIGHT))
out = cv2.VideoWriter("2. vehicle_speed_detection/videos/output/dte_output.mp4", cv2.VideoWriter_fourcc(*"mp4v"), fps, (w, h))

# ---- INTERACTIVE LINE DRAWING ----
# ---- DEFAULT LINE POSITIONS ----
default_line1_start = (355, 462)
default_line1_end   = (580, 477)
default_line2_start = (202, 575)
default_line2_end   = (542, 615)
...
print("Saved vehicle timings to dte_vehicle_timings.csv")

cap.release()
out.release()
print("Saved video as dte_output.mp4")
